...
void i2s0_tx_isr(void) {
  ...
  left_sampleIn = I2S0_RDR0;//copied from RX because RX is synced to TX cloxk.
  
  left_sampleOut = left_sampleIn; //put audio rate function here.
