...
void setup() {
  ...
  filter3.resonance(q);
  filter3.frequency(startFreq * 4);
  filter3.octaveControl(octave);

  filter4.resonance(q);
  filter4.frequency(startFreq * 8);
  filter4.octaveControl(octave);

  filter5.resonance(q);
  filter5.frequency(startFreq * 16);
  filter5.octaveControl(octave);

  filter6.resonance(q);
  filter6.frequency(startFreq * 32);
  filter6.octaveControl(octave);

  filter7.resonance(q);
  filter7.frequency(startFreq * 64);
  filter7.octaveControl(octave);

  filter8.resonance(q);
  filter8.frequency(startFreq * 128);
