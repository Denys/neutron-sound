void FASTRUN outUpdateISR_ADT(void){
 //noInterrupts();  
...
//    
    ...
    FinalOut = ((((o4.wave+o6.wave)>>1)*((int)mixDetuneUp))>>14)  +  (((o2.wave*((int)mixDetuneDn))>>14)); //main out and mix detune
