void FASTRUN outUpdateISR_MAIN(void) {
  ...
  switch (oscMode) {
    ...
    case 0:
      ...
      FinalOut = ((((o10.wave + o4.wave + o6.wave + o8.wave + o2.wave) >> 2) * ((int)mixDetuneUp)) >> 14)  +  (((o2.wave * ((int)mixDetuneDn)) >> 14)); //main out and mix detune
    ...
    case 2:
      ...
      o1.index = (FMIndex * o1.wave);
      o2.phase = o2.phase +  (o2.phase_increment + o1.index);
      if (o2.phaseOld > o2.phase){AGCtest = AGCtestPeriod;AGCtestPeriod = 2000;} //set AGC value
    ...
    case 1://-------------------------------------------CZ MODE OSCILLATORS-----------------------------------------------
      ...
      o1.phase = o1.phase + o1.phase_increment;
      noiseTable[o1.phase >> 23] = random(-32767, 32767); //replace noise cells with random values.
      if (o1.phaseOld > o1.phase){o2.phase = 0;AGCtest = AGCtestPeriod;AGCtestPeriod = 2000;} //check for sync reset osc in CZ mode.
      ...
      //  FinalOut = o1.wave >>13;
     o3.wave = (((o9.wave + o7.wave + o5.wave + o3.wave + o1.wave) >> 2) * (int)(mixDetuneUp))>> 10;
      
      AGCtestPeriod = max(AGCtestPeriod,(abs(o3.wave)));

      
      if (AGCtestSmooth > AGCtest) AGCtestSmooth --;
      else if (AGCtestSmooth < AGCtest) AGCtestSmooth ++;
      
      FinalOut = (o3.wave+((o3.wave * (4097 - AGCtestSmooth))>>12)) +  (((o1.wave * ((int)mixDetuneDn)) >> 10)); //main out and mix detune
